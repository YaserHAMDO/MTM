...
public class MeActivity extends AppCompatActivity implements ZoomClass.ZoomClassListener{
...
//        Toast.makeText(this, "onSwipeUp", Toast.LENGTH_SHORT).show();
    ...
    public void onSingleTapUp() {
        h.setVisibility(h.getVisibility() == View.VISIBLE ? View.GONE : View.VISIBLE);
    }
