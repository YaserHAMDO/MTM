...
import com.medyatakip.app.adapter.NewspaperAdapter;
import com.medyatakip.app.model.NewspaperModel;
        ...
        call.enqueue(new Callback<NewspaperFirstPagesResponse>() {
            ...
            public void onResponse(Call<NewspaperFirstPagesResponse> call, Response<NewspaperFirstPagesResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    DataHolder.getInstance().setModels1(model1);
...
//                    startActivity(intent);
                    ...
                    Intent intent = new Intent(NewspaperActivity.this, MainActivity2.class);
                    intent.putExtra("mediaPath", mediaPath + "page/" + pageFile + "-");
                    intent.putExtra("count", count);
                    intent.putExtra("index", 1);
                    intent.putExtra("position", position);
...
//            case 1:
//
//                Intent intent = new Intent(NewspaperActivity.this, Activity2.class);
//
//                intent.putExtra("index", index);
//                intent.putExtra("position", position);
//
