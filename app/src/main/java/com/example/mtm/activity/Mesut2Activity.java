...
public class Mesut2Activity extends AppCompatActivity implements ZoomClass.ZoomClassListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mesut2);
...
//        }
        ...
        System.out.println("hasan imageUrl " + imageUrl);
        Glide.with(this)
                .load(imageUrl)
