...
//        adapter.notifyDataSetChanged();
        ...
        Call<NewsPaperFullPagesModel> call = apiService.newspaperFullPages(
        ...
        call.enqueue(new Callback<NewsPaperFullPagesModel>() {
            @Override
            public void onResponse(Call<NewsPaperFullPagesModel> call, Response<NewsPaperFullPagesModel> response) {
...
//                adapter.notifyDataSetChanged();
                ...
                if (response.isSuccessful()) {
                    ...
                    NewsPaperFullPagesModel result = response.body();
...
//                    String mediaPath = "arc/pm/2024/01/29/0000014847/page/" + "63ff26eb-";
            ...
            @Override
            public void onFailure(Call<NewsPaperFullPagesModel> call, Throwable t) {
//
//                // Show progress bar for the clicked item
//                itemData.setProgressBarVisible(false);
//
